...
stikers_in_mos_popular = most_popular.find_elements(By.CSS_SELECTOR, 'a.link')
...
stikers_in_box_compaings= most_popular.find_elements(By.CSS_SELECTOR, 'a.link')
for x in stikers_in_box_compaings:
    assert len(x.find_elements(By.CSS_SELECTOR, 'div.sticker')) == 1

box_latest_products = driver.find_element(By.ID, 'box-latest-products')
stikers_in_box_latest_products= most_popular.find_elements(By.CSS_SELECTOR, 'a.link')
