...
#     time.sleep(1)
#     a = Select(driver.find_elements(By.CSS_SELECTOR, 'select'))
#     for d in a.options:
#         print(d.text)
...
for i in x:
    ...
    for x in range(len_zones)[2:]:
        zones = driver.find_element(By.XPATH, f'//*[@id="table-zones"]/tbody/tr[{x}]/td[3]/select').get_attribute('selected')
        list_geozones.append(zones)
